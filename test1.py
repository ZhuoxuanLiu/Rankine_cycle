...
wasteHeatT = 273.15+90
#选择冷凝温度30°C，蒸发温度140°C，计算冷凝蒸发压力
P3 = CP.PropsSI('P', 'T', 303.15, 'Q', 0, 'R245fa')
P1 = P5 = CP.PropsSI('P', 'T', 273.15+70, 'Q', 1, 'R245fa')
s3 = CP.PropsSI('S', 'T', 303.15, 'Q', 0, 'R245fa')
h3 = CP.PropsSI('H', 'P', P3, 'Q', 0, 'R245fa')
s1 = s2s = CP.PropsSI('S', 'P', P5, 'T', 273.15+80, 'R245fa')
eta = 0.9
h1 = CP.PropsSI('H', 'P', P5, 'T', 273.15+80, 'R245fa')
